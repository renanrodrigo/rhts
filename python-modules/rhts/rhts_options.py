...
argument, otherwise the long argument must be the first argument"""
        ...
        self.add_option(
            ...
            metavar="ADDREPO",
            action="append",
            help="Location to add repo... i.e. http://hostname/dir;\
                ftp://hostname/dir;file:///full/path/to/dir")
...
You can use this option multiple times to install multiple packages.")
        ...
        self.add_option(
            ...
            metavar="NONR",
            action="store_true",
            help="Enable yum repository from koji.fedoraproject.org\
...
user to override the default whiteboard")
        self.add_option(
            ...
            metavar="PCIID",
            action="append",
            help="Specify the PCI ID (vendorid:partid) to look for when\
 choosing a machine")
